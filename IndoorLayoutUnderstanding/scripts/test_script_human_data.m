...
%%
[params, info] = trainLITM_ssvm_iter(patterns, labels, annos, params, 1, 'human_itm_allview_refobj_picked6_22', false);
paramfile = 'cache/human_itm_oneview/iter5/params.mat';
%%
...
%%
for kkk = 1:2
    paramfile = ['cache/human_itm_oneview/iter' num2str(kkk) '/params.mat'];
    load(paramfile);
...
for kkk = 1
    paramfile = ['cache/human_itm_oneview_refobj/iter' num2str(kkk) '/params.mat'];
    load(paramfile);
    % res = struct('spg', cell(length(data), 1), 'maxidx', [], 'h', []);
    paramsout.numsamples = 1000;
    paramsout.pmove = [0 0.4 0 0.3 0.3 0 0 0];
