...
if(1)
    ...
    if(1)
        ...
        params = appendITMtoParams(params, ptn);
    else
...
%%
[params, info] = trainLITM_ssvm_iter(patterns, labels, annos, params, 5, 'human_itm_oneview', false);
...
%%
for kkk = 2:3
    paramfile = ['cache/simulitm_v3/iter' num2str(kkk) '/params.mat'];
    load(paramfile);
