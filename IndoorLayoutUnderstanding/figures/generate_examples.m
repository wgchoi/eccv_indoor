...
for i = idx
    ...
    saveas(gcf, fullfile(fullfile(figbase, 'baseline'), ['ranked' num2str(count, '%03d')]), 'pdf');
    ...
    saveas(gcf, fullfile(fullfile(figbase, 'full'), ['ranked' num2str(count, '%03d')]), 'pdf');
    ...
    saveas(gcf, fullfile(fullfile(figbase, 'partial'), ['ranked' num2str(count, '%03d')]), 'pdf');
