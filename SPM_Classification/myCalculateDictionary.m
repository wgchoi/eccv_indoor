function [ dictionary ] = myCalculateDictionary( imageFileList, imageBaseDir, dataBaseDir, dicBaseDir, featureSuffix, params, canSkip, pfig )
...
outFName = fullfile(dicBaseDir, sprintf('dictionary_%d.mat', params.dictionarySize));
...
inFName = fullfile(dicBaseDir, 'f_order.txt');
