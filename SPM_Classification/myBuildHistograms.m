function [ H_all ] = myBuildHistograms( imageFileList,imageBaseDir, dataBaseDir, dicBaseDir, histBaseDir, featureSuffix, params, canSkip, pfig )
%function [ H_all ] = myBuildHistograms( imageFileList,imageBaseDir, dataBaseDir, featureSuffix, params, canSkip, pfig )
...
inFName = fullfile(dicBaseDir, sprintf('dictionary_%d.mat', params.dictionarySize));
...
for f = 1:length(imageFileList)
    ...
    outFName = fullfile(histBaseDir, sprintf('%s_texton_ind_%d.mat', baseFName, params.dictionarySize));
