function [ pyramid_all ] = myCompilePyramid( imageFileList, histBaseDir, pyramidBaseDir, textonSuffix, params, canSkip, pfig )
%function [ pyramid_all ] = myCompilePyramid( imageFileList, dataBaseDir, textonSuffix, params, canSkip, pfig )
...
for f = 1:length(imageFileList)
    ...
    outFName = fullfile(pyramidBaseDir, sprintf('%s_pyramid_%d_%d.mat', baseFName, params.dictionarySize, params.pyramidLevels));
    ...
    %% load texton indices
    in_fname = fullfile(histBaseDir, sprintf('%s%s', baseFName, textonSuffix));
...
outFName = fullfile(pyramidBaseDir, sprintf('pyramids_all_%d_%d.mat', params.dictionarySize, params.pyramidLevels));
